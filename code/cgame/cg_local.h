...
typedef enum { LEBS_NONE, LEBS_BLOOD } leBounceSoundType_t; // fragment local entities can make sounds on impacts
...
typedef enum { PT_GRAVITY, PT_LINEAR_UP, PT_LINEAR_DOWN, PT_LINEAR_BOTH } particleType_t;
