...
#define INGAME_CANCEL0 	"menu/assets/back_0"
#define INGAME_CANCEL1 	"menu/assets/back_1"
#define INGAME_ACCEPT0 	"menu/assets/accept_0"
#define INGAME_ACCEPT1 	"menu/assets/accept_1"

#define SERVER_ITEM_RESET0 	"menu/assets/reset_0"
#define SERVER_ITEM_RESET1 	"menu/assets/reset_1"
//#define SERVER_ITEM_CLEAR0 	"menu/assets/clear_0"
//#define SERVER_ITEM_CLEAR1 	"menu/assets/clear_1"
...
static void StartServer_BothItemMenus_DrawItemButton( void* ptr )
{
	...
	icon = trap_R_RegisterShaderNoMip(va("gui_%s", iconname));
	if (!icon)
...
=================
*/
void GUI_InGame_EnabledItems(void)
{
