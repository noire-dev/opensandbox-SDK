...
void UI_MainMenu(void) {
	...
	mainmenu_items = 0;
	if(uis.onmap) {
		UI_CButton(&main.e[0], 18 - uis.wideoffset, y+4, "Resume game", UI_LEFT, 0.90, color_white, NULL, NULL, UI_ForceMenuOff, NULL, 0); y += 20; mainmenu_items++;
	}
	UI_CButton(&main.e[1], 18 - uis.wideoffset, y+4, "Start New Game", UI_LEFT, 0.90, color_white, NULL, NULL, UI_NewGame, NULL, 0); y += 20; mainmenu_items++;
	UI_CButton(&main.e[2], 18 - uis.wideoffset, y+4, "Find Multiplayer Game", UI_LEFT, 0.90, color_white, NULL, NULL, UI_ArenaServersMenu, NULL, 0); y += 20; mainmenu_items++;
	UI_CButton(&main.e[3], 18 - uis.wideoffset, y+4, "Profile", UI_LEFT, 0.90, color_white, NULL, NULL, UI_PlayerModelMenu, NULL, 0); y += 20; mainmenu_items++;
	UI_CButton(&main.e[4], 18 - uis.wideoffset, y+4, "Options", UI_LEFT, 0.90, color_white, NULL, NULL, UI_Options, NULL, 0); y += 20; mainmenu_items++;
	if(uis.onmap) {
		UI_CButton(&main.e[5], 18 - uis.wideoffset, y+4, "Disconnect", UI_LEFT, 0.90, color_white, "disconnect \n", NULL, NULL, NULL, 0); y += 20; mainmenu_items++;
	}
	UI_CButton(&main.e[6], 18 - uis.wideoffset, y+4, "Quit", UI_LEFT, 0.90, color_white, "quit \n", NULL, NULL, NULL, 0); mainmenu_items++;
