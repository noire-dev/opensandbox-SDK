...
#define BOTSELECT_BACK0			"menu/assets/back_0"
#define BOTSELECT_BACK1			"menu/assets/back_1"
#define BOTSELECT_ACCEPT0		"menu/assets/accept_0"
#define BOTSELECT_ACCEPT1		"menu/assets/accept_1"
#define BOTSELECT_SELECT		"menu/assets/opponents_select"
#define BOTSELECT_SELECTED		"menu/assets/opponents_selected"
#define BOTSELECT_SMALLSELECTED		"menu/assets/opponents_smallselected"
#define BOTSELECT_ARROWS		"menu/assets/gs_arrows_0"
#define BOTSELECT_ARROWSL		"menu/assets/gs_arrows_l"
#define BOTSELECT_ARROWSR		"menu/assets/gs_arrows_r"
...
{
	trap_Cvar_SetValue("gui_bot_multisel", botSelectInfo.multisel.curvalue);
...
static void UI_BotSelect_SetViewType( void )
{
	...
	trap_Cvar_SetValue("gui_bot_list", botSelectInfo.viewlist.curvalue);
}
...
static void UI_BotSelect_Init( char *bot , int index) {
	...
	botSelectInfo.viewlist.curvalue = (int)Com_Clamp(0, 1, trap_Cvar_VariableValue("gui_bot_list"));
	botSelectInfo.multisel.curvalue = (int)Com_Clamp(0, 1, trap_Cvar_VariableValue("gui_bot_multisel"));
