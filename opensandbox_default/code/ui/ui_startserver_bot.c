...
#define BOTSELECT_SWAPARROWS0 "menu/assets/swaparrows_0"
#define BOTSELECT_SWAPARROWS1 "menu/assets/swaparrows_1"
#define BOTSELECT_DEL0 "menu/assets/del_0"
#define BOTSELECT_DEL1 "menu/assets/del_1"
