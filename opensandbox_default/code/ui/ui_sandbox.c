...
static void SandboxMain_MenuDraw( void ) {
	...
	UI_DrawRoundedRect(20-uis.wideoffset, 40, 600+uis.wideoffset*2, 435, 6, sbcolor1);
	UI_DrawRoundedRect(372-5+uis.wideoffset, 70-25, 225+10, (160*2)+50+55, 8, sbcolor2);	//tools
	
	if(uis.sb_tab == STAB_CREATE){
	UI_DrawRoundedRect(40-5-uis.wideoffset, 70-25, 225+100+(uis.wideoffset*2), 160+50, 8, sbcolor2);//props
	UI_DrawRoundedRect(40-5-uis.wideoffset, 215+70-25, 225+100+(uis.wideoffset*2), 160+50, 8, sbcolor2);//classes
	}
	if(uis.sb_tab == STAB_ENTITIES){
	UI_DrawRoundedRect(40-5-uis.wideoffset, 70-25, 225+100+(uis.wideoffset*2), (160*2)+50+55, 8, sbcolor2);//props
	}
	if(uis.sb_tab == STAB_NPC){
	UI_DrawRoundedRect(40-5-uis.wideoffset, 70-25, 225+100+(uis.wideoffset*2), 160+50, 8, sbcolor2);//props
	UI_DrawRoundedRect(40-5-uis.wideoffset, 215+70-25, 225+100+(uis.wideoffset*2), 160+50, 8, sbcolor2);//classes
	...
	for (i = 1; i <= 10; i++) {
		...
		if(strlen(get_cvar_char(va("sb_ctab_%i", i)))){
			UI_DrawRoundedRect(xOffset, 5, 52, 15, 5, sbcolor2);
		}
	}
