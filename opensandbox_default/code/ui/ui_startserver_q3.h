...
#define COLUMN_LEFT (BASEFONT_INDENT * 18)
#define COLUMN_RIGHT (320 + (BASEFONT_INDENT * 20))

#define LINE_HEIGHT (BASEFONT_HEIGHT + 2)

#define GAMETYPECOLUMN_X 400
#define GAMETYPEICON_X (GAMETYPECOLUMN_X - (20 * BASEFONT_INDENT))
