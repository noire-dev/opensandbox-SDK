...
void UI_SpawnMenu( void ) {
	...
	if(spawnmenu_tab == TB_ENTITIES)
		UI_FillListFromArray(&spawnmenu.e[0], spawnmenu.list1, gameInfoSandboxSpawns, gameInfoSandboxSpawnsNum);
	if(spawnmenu_tab == TB_NPCS)
		UI_FillListOfBots(&spawnmenu.e[0], spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	if(spawnmenu_tab == TB_ITEMS)
		UI_FillListOfItems(&spawnmenu.e[0], spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	if(spawnmenu_tab == TB_SPAWNLISTS){
		if(!strlen(spawnmenu_folder)){
	...
	if(spawnmenu_tab == TB_SCRIPTS)
		UI_FillList(&spawnmenu.e[0], "dscripts", "", ".ns", spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	if(spawnmenu_tab == TB_TOOLS)
		UI_FillList(&spawnmenu.e[0], "tools", "", ".ns", spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	if(spawnmenu_tab == TB_SAVES)
		UI_FillList(&spawnmenu.e[0], "maps", "screenshots/maps", ".ent", spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	if(spawnmenu_tab == TB_ADDBOTS)
		UI_FillListOfBots(&spawnmenu.e[0], spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	if(spawnmenu_tab == TB_REMOVEBOTS)
		UI_FillListPlayers(&spawnmenu.e[0], spawnmenu.list1, spawnmenu.names1, sizeof(spawnmenu.names1));
	if(spawnmenu_tab == TB_MUSIC)
		UI_FillList(&spawnmenu.e[0], "music", "music", "$sound", spawnmenu.names1, sizeof(spawnmenu.names1), spawnmenu.list1);
	...
	if(spawnmenu_tab == TB_NPCS){
		...
		UI_CField(&spawnmenu.e[33], 640+uis.wideoffset-110, y, "Health:", 5, 5, color_white, "uis_b2", NULL, 0); y += 12;
	...
	if(spawnmenu_tab == TB_SAVES){
		UI_CField(&spawnmenu.e[30], (640+uis.wideoffset-155)+14, 350, "Name:", 16, 16, color_white, "uis_sv1", NULL, 0); y += 12;
	}
	if(spawnmenu_tab == TB_ADDBOTS){
