...
#define MAPSELECT_HARROWS "menu/assets/arrows_horz_0"
#define MAPSELECT_NEXT "menu/assets/arrows_horz_right"
#define MAPSELECT_PREVIOUS "menu/assets/arrows_horz_left"
#define MAPSELECT_CANCEL0 "menu/assets/back_0"
#define MAPSELECT_CANCEL1 "menu/assets/back_1"
#define MAPSELECT_ACCEPT0 "menu/assets/accept_0"
#define MAPSELECT_ACCEPT1 "menu/assets/accept_1"
#define MAPSELECT_MAPFOCUS "menu/assets/mapfocus"
#define MAPSELECT_MAPSELECTED "menu/assets/maps_selected"

#define MAPNAME_LONGBUFFER 64

#define MAPSELECT_ERRORPIC "menu/assets/unknownmap"
...
{
	trap_Cvar_SetValue("gui_map_multisel", s_mapselect.multisel.curvalue);
...
static void MapSelect_MenuEvent( void* ptr, int event )
{
	...
	case ID_MAPSELECT_LISTVIEW:
		trap_Cvar_SetValue("gui_map_list", s_mapselect.listview.curvalue);
		MapSelect_SetViewType();
		MapSelect_SetNewMapPage();
		MapSelect_UpdateInterface();
		break;
	...
	case ID_MAPSELECT_MAPICONS:
		trap_Cvar_SetValue("gui_mapicons", s_mapselect.mapicons.curvalue);
		break;
	}
}
