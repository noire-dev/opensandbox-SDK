...
static imageSource_t guiImageList[] = {
...
static creditEntry_t gui_credits[] = {
	{ CMODE_TEXT, "OpenSandbox", {"OpenSandbox Team", 0, 0, 0  } },
	{ CMODE_TEXT, "Game", {"Noire.dev", "Vovan_Vm", 0, 0} },
	{ CMODE_TEXT, "Additional Mods", {"CannerZ45 (CZ45)", 0, 0, 0} },
	{ CMODE_TEXT, "Design", {"Noire.dev", "teapxt", 0, 0} },
...
static dateImageList_t gui_dateImages[] = {
	{ 31, 11, { 0, "menu/assets/imagenewyear.tga", 1.0, 0, NULL, 1.0, 0 }},
	{ 16, 7, { 0, "menu/assets/imagesecret.tga", 1.0, 0, NULL, 1.0, 0 }},
	{ 22, 2, { 0, "menu/assets/imagesecret.tga", 1.0, 0, NULL, 1.0, 0 }}
};
...
static creditList_t endCredits[] = {
	{ CREDIT_NORMAL|CREDIT_SILLYTITLE|CREDIT_REVERSETEXT,
		gui_credits, ARRAY_SIZEOF(gui_credits),
		"ui_creditdisc", guiImageList, ARRAY_SIZEOF(guiImageList),
		gui_dateImages, ARRAY_SIZEOF(gui_dateImages),
