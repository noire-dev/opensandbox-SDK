...
static void PlayerModel_MenuInit( void ) {
	...
	UI_CText(&s_playermodel.e[0], 320, 16, "PLAYER MODEL", UI_CENTER, 1.00);

	y = 68;
	UI_CSlider(&s_playermodel.e[1], 100, y, "^1Head:", "headR", 0, 255, 1, NULL, 0); y += 18;
	UI_CSlider(&s_playermodel.e[2], 100, y, "^2Head:", "headG", 0, 255, 1, NULL, 0); y += 18;
	UI_CSlider(&s_playermodel.e[3], 100, y, "^4Head:", "headB", 0, 255, 1, NULL, 0); y = 68;

	UI_CSlider(&s_playermodel.e[4], 300, y, "^1Torso:", "modelR", 0, 255, 1, NULL, 0); y += 18;
	UI_CSlider(&s_playermodel.e[5], 300, y, "^2Torso:", "modelG", 0, 255, 1, NULL, 0); y += 18;
	UI_CSlider(&s_playermodel.e[6], 300, y, "^4Torso:", "modelB", 0, 255, 1, NULL, 0); y = 68;

	UI_CSlider(&s_playermodel.e[7], 500, y, "^1Legs:", "legsR", 0, 255, 1, NULL, 0); y += 18;
	UI_CSlider(&s_playermodel.e[8], 500, y, "^2Legs:", "legsG", 0, 255, 1, NULL, 0); y += 18;
	UI_CSlider(&s_playermodel.e[9], 500, y, "^4Legs:", "legsB", 0, 255, 1, NULL, 0); y = 68;
